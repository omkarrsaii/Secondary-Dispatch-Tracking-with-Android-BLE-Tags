  ...
  return (
    <div className="mt-10 flex flex-col items-center gap-6 animate-fade-in text-center px-4">
      ...
      <div className="flex flex-wrap justify-center gap-2">
        {['5351225255', '5351225292', '5351225257'].map(ex => (
          <span
            key={ex}
            className="px-3 py-1.5 rounded-lg border border-rim bg-panel text-mist font-mono text-xs hover:border-ember/40 hover:text-ember transition-colors cursor-default"
          >
            {ex}
          </span>
        ))}
        <span className="px-3 py-1.5 rounded-lg border border-rim/40 text-mist/40 font-mono text-xs cursor-default">
          example numbers ↑
        </span>
      </div>
    </div>
